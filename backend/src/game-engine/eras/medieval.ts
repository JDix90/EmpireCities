...
export const MEDIEVAL_TECH_TREE: TechNode[] = [
  ...
  // Tier 2
  {
    ...
    name: 'Siege Warfare',
    description: 'Trebuchets and siege towers — +1 attack die and unlocks Siege Assault.',
    tier: 2,
  ...
  // Tier 4
  {
    ...
    name: 'Royal Dominion',
    description: 'Absolute monarchy consolidates power: +3 reinforcements per turn and unlocks Royal Decree.',
    tier: 4,

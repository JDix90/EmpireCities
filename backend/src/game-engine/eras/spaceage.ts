...
export const SPACE_AGE_FACTIONS: Faction[] = [
  {
    ...
    description: 'Satellite-backed democracies — +1 attack die on every attack; recovers stability quickly.',
  ...
  },
  {
    ...
    description: 'Energy hegemony of the post-petroleum age — +1 reinforcement per turn.',

...
ADMIN = {
    ...
    "gc_caribbean": {"admin1": [
        "CO-LAG", "CO-MAG", "CO-ATL", "CO-BOL", "CO-CES", "CO-COR", "CO-SUC",
        "CO-SAP", "CO-CHO"]},
    "gc_bogota": {"admin1": [
        "CO-ANT", "CO-CUN", "CO-DC", "CO-BOY", "CO-SAN", "CO-NSA", "CO-ARA",
        "CO-CAS", "CO-MET", "CO-VID", "CO-GUA", "CO-GUV", "CO-VAU", "CO-CAQ",
        "CO-PUT", "CO-AMA", "CO-HUI", "CO-TOL", "CO-CAL", "CO-RIS", "CO-QUI",
        "CO-VAC", "CO-CAU", "CO-NAR"]},
    "gc_venezuela": {"admin1": [
        "VE-V", "VE-T", "VE-L", "VE-S", "VE-I", "VE-K", "VE-U", "VE-G", "VE-D",
        "VE-M", "VE-A", "VE-X", "VE-O", "VE-H", "VE-P", "VE-E", "VE-C", "VE-J",
        "VE-W"]},
    "gc_orinoco": {"admin1": [
        "VE-B", "VE-R", "VE-N", "VE-Y", "VE-F", "VE-Z"]},
    "gc_ecuador": {"iso_codes": ["EC"]},

    # ---- Brazil (all 27 states) ----
    "br_amazonas": {"admin1": ["BR-AM", "BR-AC", "BR-RR", "BR-RO"]},
    "br_para": {"admin1": ["BR-PA", "BR-AP"]},
    "br_nordeste": {"admin1": [
        "BR-MA", "BR-PI", "BR-CE", "BR-RN", "BR-PB", "BR-PE", "BR-AL", "BR-SE"]},
    "br_bahia": {"admin1": ["BR-BA"]},
    "br_minas": {"admin1": ["BR-MG", "BR-GO", "BR-DF", "BR-TO"]},
    "br_rio": {"admin1": ["BR-RJ", "BR-ES"]},
    "br_saopaulo": {"admin1": ["BR-SP"]},
    "br_sul": {"admin1": ["BR-PR", "BR-SC", "BR-RS"]},
    "br_matogrosso": {"admin1": ["BR-MT", "BR-MS"]},

    # ---- Andean Federation (Peru 26 + Bolivia 9) ----
    "an_peru_north": {"admin1": [
        "PE-TUM", "PE-PIU", "PE-LAM", "PE-CAJ", "PE-LAL", "PE-AMA", "PE-SAM",
        "PE-LOR", "PE-ANC", "PE-HUC", "PE-UCA"]},
    "an_peru_central": {"admin1": [
        "PE-LIM", "PE-LMA", "PE-CAL", "PE-ICA", "PE-JUN", "PE-PAS", "PE-HUV",
        "PE-AYA"]},
    "an_peru_south": {"admin1": [
        "PE-CUS", "PE-ARE", "PE-APU", "PE-PUN", "PE-MOQ", "PE-TAC", "PE-MDD"]},
    "an_altiplano": {"admin1": ["BO-L", "BO-O", "BO-P", "BO-C"]},
    "an_bolivia_east": {"admin1": ["BO-S", "BO-B", "BO-N", "BO-H", "BO-T"]},

    # ---- Chile (all 15 regions) ----
    "cl_norte": {"admin1": ["CL-AP", "CL-TA", "CL-AN", "CL-AT"]},
    "cl_centro": {"admin1": ["CL-CO", "CL-VS", "CL-RM", "CL-LI", "CL-ML"]},
    "cl_araucania": {"admin1": ["CL-BI", "CL-AR", "CL-LR", "CL-LL"]},
    "cl_patagonia": {"admin1": ["CL-AI", "CL-MA"]},

    # ---- Guaraní / Paraguay (all 18 departments) ----
    "gu_chaco": {"admin1": ["PY-19", "PY-16", "PY-15"]},
    "gu_oriental": {"admin1": [
        "PY-1", "PY-2", "PY-3", "PY-4", "PY-5", "PY-6", "PY-7", "PY-8", "PY-9",
        "PY-10", "PY-11", "PY-12", "PY-13", "PY-14", "PY-ASU"]},

    # ---- Greater Argentina / Río de la Plata (Argentina 24 + Uruguay) ----
    "pl_norte": {"admin1": ["AR-A", "AR-Y", "AR-T", "AR-K", "AR-G"]},
    "pl_litoral": {"admin1": ["AR-P", "AR-H", "AR-W", "AR-N", "AR-E", "AR-S"]},
    "pl_cordoba": {"admin1": ["AR-X", "AR-F", "AR-J"]},
    "pl_buenosaires": {"admin1": ["AR-B", "AR-C"]},
    "pl_uruguay": {"iso_codes": ["UY"]},
    "pl_mendoza": {"admin1": ["AR-M", "AR-D"]},
    "pl_pampa_sur": {"admin1": ["AR-L", "AR-Q"]},
    "pl_patagonia": {"admin1": ["AR-R", "AR-U"]},
    "pl_santacruz": {"admin1": ["AR-Z", "AR-V"]},
}

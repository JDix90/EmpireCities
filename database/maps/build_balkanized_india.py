...
# --- Real Natural Earth admin geometry per territory (codes from subdivisions_ref "IN" / countries_ref "LK") ---
# Some real single states are split by the map into several territories (Rajasthan, Uttar Pradesh,

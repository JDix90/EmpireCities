...
export const COMBINED_CORE_TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    id: 'wrapup',
    title: 'You\'re Ready!',
    message: 'You ran the full turn cycle — draft, attack, fortify — and climbed an era. That is the whole loop. The default way to win is domination: capture every territory. Hosts can also pick Threshold (a share of the map), Capital Capture, or Secret Missions.',
